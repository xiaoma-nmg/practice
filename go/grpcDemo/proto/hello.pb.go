...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_513967a66434ea58, []int{0}
}
...
func (*HelloReplay) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_513967a66434ea58, []int{1}
}
...
func (*HelloMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_513967a66434ea58, []int{2}
}
...
func (c *helloServerClient) SayHi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReplay, error) {
	out := new(HelloReplay)
	err := c.cc.Invoke(ctx, "/pb.HelloServer/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServerClient) GetMsg(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.HelloServer/GetMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloServer_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.HelloServer/SayHi",
	}
...
func _HelloServer_GetMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.HelloServer/GetMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("hello.proto", fileDescriptor_hello_513967a66434ea58) }

var fileDescriptor_hello_513967a66434ea58 = []byte{
	...
	0xa6, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0x81, 0xd9, 0x4a, 0xea, 0x5c, 0xdc, 0x50, 0x35,
	0x05, 0x39, 0x89, 0x95, 0x42, 0x12, 0x5c, 0xec, 0xb9, 0xa9, 0xc5, 0xc5, 0x89, 0xe9, 0x30, 0x55,
	0x30, 0xae, 0x92, 0x02, 0xd4, 0x30, 0x5f, 0x08, 0x5f, 0x48, 0x80, 0x8b, 0x39, 0xb7, 0x38, 0x1d,
	0xaa, 0x0a, 0xc4, 0x34, 0xca, 0x86, 0x1a, 0x15, 0x9c, 0x5a, 0x54, 0x96, 0x5a, 0x24, 0xa4, 0xc3,
	0xc5, 0x1a, 0x9c, 0x58, 0xe9, 0x91, 0x29, 0x24, 0xa0, 0x57, 0x90, 0xa4, 0x87, 0xec, 0x10, 0x29,
	0x7e, 0x24, 0x11, 0x90, 0xb5, 0x4a, 0x0c, 0x42, 0x7a, 0x5c, 0x6c, 0xee, 0xa9, 0x25, 0xbe, 0xc5,
	0xe9, 0x58, 0x94, 0x23, 0x44, 0xa0, 0x96, 0x2b, 0x31, 0x24, 0xb1, 0x81, 0xbd, 0x69, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0xc2, 0x3d, 0x6a, 0x72, 0xf5, 0x00, 0x00, 0x00,
}
